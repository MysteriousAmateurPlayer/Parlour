...
const SITE_HOME_FIELDS = [
  ...
  { group: '主视觉（首屏）', key: 'hero.primary.icon', label: '主按钮图标', type: 'string', hint: '默认 axes（坐标系）；可填 axes / clock / sun / moon / planet / globe / telescope / atom / compass / sigma / pi 等' },
  ...
  { group: '主视觉（首屏）', key: 'hero.secondary.icon', label: '次按钮图标', type: 'string', hint: '默认 clock（时钟）' },
